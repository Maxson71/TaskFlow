          ...
          <div className="flex justify-center content-center">
              <div
                  ...
                  <div className="flex flex-col space-y-1 items-start justify-start">
                      <p className="w-full text-sm font-semibold text-gray-600">ChatGPT Tricks for business
                          marketing</p>
                      <p className="w-full text-xs font-medium text-gray-400">Lorem ipsum dolor sit amet, consectetur
                          adipiscing elit. Ut id dui mi. Fusce varius bibendum ante, non lacinia. Fall usasc ce variu
                          slorem ipsum dolor sit amet</p>
                  </div>
