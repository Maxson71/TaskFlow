        ...
        <div className="flex justify-center content-center">
            <div className="inline-flex flex-col space-y-2.5 items-start justify-start px-4 py-3.5 bg-white shadow border rounded-lg border-gray-200">
                ...
                <div className="flex flex-col space-y-1 items-start justify-start">
                    <p className="w-full text-sm font-semibold text-gray-600">ChatGPT Tricks for business marketing</p>
                    <p className="w-full text-xs font-medium text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut id dui mi. Fusce varius bibendum ante, non lacinia. Fall usasc ce variu slorem ipsum dolor sit amet</p>
                </div>
